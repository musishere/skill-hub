      ...
      <div className="w-full bg-white overflow-hidden mb-10  rounded-lg">
        <div className="h-full overflow-y-auto overflow-x-hidden relative bg-gray-50 scrollbar-hide">
          ...
          <div className="bg-white mb-2">
            <div
              className="p-4 flex justify-between items-center cursor-pointer"
              onClick={() => toggleSection("sessionRequirements")}
            >
              <div className="flex items-center gap-3">
                <div className="text-base font-semibold text-gray-800">
                  Session Requirements
                </div>
                <div className="py-1 px-3 rounded-full text-xs font-semibold flex items-center gap-1.5 bg-green-100 text-green-500">
                  <svg
                    className="w-4 h-4"
                    viewBox="0 0 20 20"
                    fill="currentColor"
              ...
              <ChevronDown
                className={`w-5 h-5 transition-transform ${
                  expandedSections.sessionRequirements ? "rotate-180" : ""
                }`}
              />
            </div>
            {expandedSections.sessionRequirements && (
              <div className="p-4 border-t border-gray-200">
                {/* Max Course Sections */}
                <div className="bg-white border border-gray-200 rounded-lg mb-3 last:mb-0">
                  <div
                    className="p-4 grid grid-cols-[32px_1fr] gap-3"
                    onClick={(e) => toggleItemDetails("maxCourseSections", e)}
                  >
                    <div className="flex items-center justify-center">
                      <LayoutList className="w-6 h-6 text-cyan-500" />
                    </div>
                    <div className="text-sm text-gray-800 font-semibold self-center">
                      Maximum Course Sections
                    </div>
                    <div className="col-span-2 flex items-center justify-center gap-2 p-2.5 mt-2 w-full rounded-lg text-xs font-semibold bg-green-100 border border-green-300 text-green-600">
                      <svg
                        className="w-5 h-5 flex-shrink-0"
                  ...
                  {expandedItems.maxCourseSections && (
                    <div className="p-4 bg-gray-50 border-t border-gray-200">
                      <p className="text-sm text-gray-500 leading-relaxed">
                        Course sections are within the allowed limit. Current: 8
                        sections (Maximum: 12)
                      </p>
                    </div>
                  )}
                ...
                <div className="bg-white border border-gray-200 rounded-lg mb-3 last:mb-0">
                  <div
                    className="p-4 grid grid-cols-[32px_1fr] gap-3"
                    onClick={(e) =>
                      toggleItemDetails("alternativeLearningActivities", e)
                    }
                  >
                    <div className="flex items-center justify-center">
                  ...
                  {expandedItems.alternativeLearningActivities && (
                    <div className="p-4 bg-gray-50 border-t border-gray-200">
                      <p className="text-sm text-gray-500 leading-relaxed">
                        Alternative learning activities are properly configured
                        for all sections.
                      </p>
                    </div>
                  )}
