...
import { Bold, Italic, X, Underline } from "lucide-react";
...
export default function CreateSessionEdit({
  ...
  // Initialize content from sessionData.title
  useEffect(() => {
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="border border-gray-200 rounded-md overflow-hidden">
                              ...
                              <div
                                ...
                                style={{ whiteSpace: "pre-wrap" }} // preserves new lines and spacing
                              >
                                {content}
                              </div>
                            </div>
          ...
          <div className="w-full mx-auto px-33 border-b ">
            ...
            >
              <TabsList className=" gap-6 ">
                <TabsTrigger
                  value="outline"
                  className="rounded-none px-0 py-2 bg-transparent data-[state=active]:bg-accent data-[state=active]:text-teal-500 data-[state=active]:shadow-none text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary "
                >
                  Outline
                </TabsTrigger>
                ...
                <TabsTrigger
                  value="Setting"
                  className=" rounded-none px-0 py-2 data-[state=active]:text-teal-500 data-[state=active]:bg-transparent data-[state=active]:shadow-none text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary"
                >
                  Settings
                </TabsTrigger>
                <TabsTrigger
