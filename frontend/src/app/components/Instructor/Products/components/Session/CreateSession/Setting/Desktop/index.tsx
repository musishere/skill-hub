        ...
        <div className="py-6">
          <div className="space-y-8">
            ...
            {/* <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-2/3 bg-white p-6 rounded-lg border">
                ...
                <div className="space-y-4">
                  <div className="m-0.5">
                    <Input
                      defaultValue="Intro to UX Design"
                      className="w-full px-2 py-5"
                    />
                  </div>
                  <span className=" text-gray-500 text-sm pl-2 mb-2">
                    18/100 characters
                  </span>
              ...
              <div className="md:w-2/3 bg-white p-6 rounded-lg border">
                ...
                {provideCertificates && (
                  <div className="space-y-6">
                    ...
                    <div className="space-y-4 bg-gray-50 p-5 rounded-md border border-gray-200">
            ...
            <div className="flex flex-col md:flex-row gap-6">
              ...
              <div className="md:w-2/3 bg-white p-3 rounded-lg border">
                <div className="space-y-6">
                  ...
                  {isSchoolEnabled && (
                    <div className="pl-2 space-y-4">
                      <div>
                        <div className="text-lg font-bold">Linked School</div>
                      ...
                      {linkedSchool ? (
                        <div className="flex items-center justify-between bg-gray-50 p-3 rounded-lg border">
                          <div className="flex items-center gap-3">
                            <div className="w-25 h-16 rounded-lg overflow-hidden">
                              <Image
                                src={
                        ...
                        <div className="flex flex-col items-center justify-center py-8 space-y-4">
                          <div className="w-16 h-16 bg-[#50aeec] rounded-full flex items-center justify-center">
