...
export default function CourseChecklist() {
  ...
  return (
    ...
    <div className="bg-gray-100 min-h-screen flex justify-center p-8 md:p-10">
            ...
            <div className="border border-gray-200 rounded-lg ">
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="px-3 py-1 rounded-full text-xs font-semibold flex items-center gap-1.5 bg-red-50 text-red-500 min-w-[95px] whitespace-nowrap">
                    <XSvg className="w-4 h-4" />
                    {progress.sessionRequirements.total -
                      progress.sessionRequirements.completed}{" "}
                    issues
                  </div>
                </div>
                <div className="flex items-center gap-4 group">
                  ...
                  <ChevronDownSvg
                    fill="white"
                    className={`transition-transform duration-200 w-5 h-5 ${
                      expandedSections.includes("session") ? "rotate-180" : ""
                    }`}
                  />
                </div>
              </div>

              {expandedSections.includes("session") && (
                <div className="p-4">
                  {/* Link to School */}
                  <ChecklistItem
                    id="school"
                  ...
                  <ChecklistItem
                    ...
                    description={
                      <div>
                        Session requires at least 1 meeting activity. Current
                        count: 0
                      </div>
                    }
                  />
                  ...
                  <ChecklistItem
                    ...
                    description={
                      <div>
                        Session sections are within the allowed limit. Current:
                  ...
                  <ChecklistItem
                    ...
                    fixButtonText="Review Videos"
                    description={
                      <div>
                        First section exceeds maximum allowed video activities
                        (Max: 3). Current count in first section: 4
                        <div className="mt-4 flex gap-2 flex-wrap">
                          Affected videos in first section:
                          <a
                            href="#"
                  ...
                  <ChecklistItem
                    ...
                    description={
                      <div>
                        Session contains externally hosted videos which are not
                        allowed.
                        <div className="mt-4 flex gap-2 flex-wrap">
                          Affected activities:
                          <a
                          ...
                          <a
                            ...
                            className="text-sky-600 pt-1text-sm font-semibold hover:underline"
                          >
                            Module 2 Tutorial Section 3: Tutorial{" "}
                          </a>
                        </div>
                      </div>
                    }
                  ...
                  <ChecklistItem
                    ...
                    onToggle={() => toggleItem("youtube")}
                    // onFix={() => completeItem("courseRequirements", "youtube")}
                    fixButtonText="Complete Info"
                    description={
                      <div className="mb-4">
                        The following required information is missing or
                        invalid:
                        <div className="flex flex-wrap gap-2 my-2">
                          <div className="bg-red-100 text-red-500 px-3 py-1 rounded font-semibold">
                  ...
                  <ChecklistItem
                    ...
                    description="urrent featured image (350x180) does not meet minimum size requirements. Please upload an image that is at least 500x200 pixels."
                  />
                  ...
                  <ChecklistItem
                    ...
                    isCompleted={false}
                    fixButtonText="Adjust price"
                    isExpanded={expandedItems.includes("price")}
                    onToggle={() => toggleItem("price")}
                    description={
                      <div>
                        Session price ($399.99) exceeds the maximum allowed
                        price of $299.99.
                        <span className="bg-green-100 text-green-600 px-1 py-0.5 rounded font-semibold">
                          $49.99
                        </span>
                  ...
                  <ChecklistItem
                    ...
                    description={
                      <div>
                        Session contains blacklisted keywords:
                        <div className="bg-red-100 text-red-500 px-1 py-0.5 rounded font-semibold my-2">
                          exclusive, limited time only, guaranteed results
                        </div>
                        <div className="mt-2 flex gap-2 flex-wrap">
                          ...
                          >
                            Title: Exclusive Python Masterclass
                          </a>
                          <a
                            href="#"
                            className="text-sky-600 text-sm  font-semibold hover:underline"
                          >
                            Description: Limited time only offer
                          </a>
                        </div>
                      </div>
                    }
