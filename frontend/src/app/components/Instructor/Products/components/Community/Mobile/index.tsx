...
import { Bold, Italic, Underline, X, Redo, Undo } from "lucide-react";
                  ...
                  <div className="w-full lg:w-1/2 pr-4 mb-6 lg:mb-0">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        Enter the basic community details such as the title and
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <Input
                            ...
                            className="w-full border border-gray-200 p-5 rounded"
                            value={eventTitle}
                            maxLength={60}
                        ...
                        <div>
                          ...
                          <Input
                            className="w-full border border-gray-100 p-5 rounded"
                            value={eventUrl}
                            readOnly
                          />
                        </div>
