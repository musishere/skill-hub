  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        {...props}
      >
        <div className="bg-neutral-100 mx-auto mt-4 hidden h-1 w-[36px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block dark:bg-neutral-800" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  )
