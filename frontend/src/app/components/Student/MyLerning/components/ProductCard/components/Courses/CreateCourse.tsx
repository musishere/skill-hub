							...
							<div className='px-4 py-5'>
								<div className='mb-6'>
									...
									<Input
										...
										maxLength={60}
										className='mt-2 rounded-md border-[#E5E5E5] px-3 py-3 text-[15px] text-[#4F4F4F] focus-visible:ring-[#02C5AF]'
										required
									/>
								</div>
								...
								<div className='mb-6'>
									...
									<Input
										...
										value={url}
										readOnly
										className='mt-2 cursor-not-allowed rounded-md border-[#E5E5E5] bg-[#F8F9FA] px-3 py-3 text-[15px] text-[#4F4F4F]'
									/>
								</div>
								...
								<div className='mb-6'>
									...
									<div className='mt-1 overflow-hidden rounded-md border border-[#E5E5E5]'>
										...
										<div
											ref={editorRef}
											contentEditable
											className='min-h-[120px] max-h-[240px] overflow-y-auto p-3 text-[15px] leading-relaxed outline-none'
										/>
									</div>
								</div>
