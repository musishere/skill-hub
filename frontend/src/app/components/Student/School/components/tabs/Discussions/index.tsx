  ...
  const posts = [
    {
      ...
      mentions: [
        ...
        { name: 'Michael Brown', avatar: 'https://i.ibb.co/3m3G6rWg/AVATAR-laurentfa.png' }
      ]
    },
    {
      id: 2,
      ...
      mentions: [
        { name: 'Robert Taylor', avatar: 'https://i.ibb.co/gLQM1bhc/AVATAR-midtone-ux-instrgram.jpg' },
        { name: 'Lisa Anderson', avatar: 'https://i.ibb.co/BKststd4/AVATAR-Dribble.jpg' },
        { name: 'Jennifer White', avatar: 'https://i.ibb.co/3m3G6rWg/AVATAR-laurentfa.png' },
        { name: 'James Miller', avatar: 'https://i.ibb.co/N5kLzSd/AVATAR-couponcodefinder.jpg' }
      ]
    },
    {
      id: 3,
      ...
      mentions: [
        { name: 'Daniel Lee', avatar: 'https://i.ibb.co/BKststd4/AVATAR-Dribble.jpg' },
        { name: 'Sophia Garcia', avatar: 'https://i.ibb.co/3m3G6rWg/AVATAR-laurentfa.png' },
        { name: 'William Chen', avatar: 'https://i.ibb.co/N5kLzSd/AVATAR-couponcodefinder.jpg' }
      ]
    },
    {
      id: 4,
      ...
      mentions: [
        { name: 'Alex Martinez', avatar: 'https://i.ibb.co/BKststd4/AVATAR-Dribble.jpg' },
        { name: 'Rachel Kim', avatar: 'https://i.ibb.co/3m3G6rWg/AVATAR-laurentfa.png' },
        { name: 'Thomas Wright', avatar: 'https://i.ibb.co/N5kLzSd/AVATAR-couponcodefinder.jpg' }
      ]
    }
  ];
