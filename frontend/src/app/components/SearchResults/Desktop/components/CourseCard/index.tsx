...
import { Award, BookOpen, Check, Clock, MoreHorizontal, Users } from "lucide-react"
    ...
    >
      ...
      <div className="relative">
        <div className="p-3">
          ...
          <h3 className="mb-2 min-h-[2.5rem] line-clamp-2 text-sm font-semibold text-gray-800">{title}</h3>
          <p className="mb-3 text-sm italic text-gray-500">by {author}</p>
