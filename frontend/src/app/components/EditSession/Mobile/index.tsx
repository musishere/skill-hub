...
export default function EditMobileSession() {
		...
		<div className='p-4 pb-20 bg-white'>
			...
			<div className='  w-full '>
				<Tabs
					...
					className='w-full overflow-x-auto no-scrollbar border-b  px-0'
				>
						...
						<div className='space-y-8'>
							...
							<div className='flex flex-col md:flex-row gap-6'>
								...
								<div className='md:w-2/3 bg-white p-5 rounded-lg border'>
									...
									<div className='space-y-4'>
										<div className='flex items-center justify-between p-2 border border-gray-400 rounded-xl bg-white w-full'>
