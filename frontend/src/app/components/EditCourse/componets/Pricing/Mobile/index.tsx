    ...
    if (searchQuery1.trim() === "") {
      ...
      setFilteredSubscriptions(
        subscriptions.filter(
          (sub) =>
            !sub.selected &&
            sub.title.toLowerCase().includes(searchQuery1.toLowerCase())
        )
      );
    }
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row">
        ...
        <div className="md:w-2/3 bg-white px-4">
          <div className="space-y-4 bg-gray-100  rounded-lg p-4">
            ...
            <div className="flex w-full items-center gap-2 bg-white my-3 border-2 rounded-lg overflow-hidden pl-6">
              <span className="text-white-100">$</span>
              <input
                className="border-0 rounded py-1 overflow-hidden outline-0"
                placeholder="0"
              />
            </div>
          ...
          <div className=" bg-gray-100 mt-4  p-4 space-y-4 rounded-lg">
            <div className=" ">
            ...
            <div className="">
              <div className="flex items-center justify-between border border-gray-300 p-2 rounded-md bg-white">
          ...
          <div className="space-y-4 bg-gray-100 p-4 rounded-lg mt-4">
            <div className="  ">
              <div className="">
                ...
                <div className="flex items-center gap-2 w-full my-3 bg-white border-2 rounded-lg overflow-hidden pl-5">
                  <span className="text-white-100">$</span>
                  <input
                    type="number"
                    className="border-0 rounded p-1 overflow-hidden outline-0 "
                    placeholder="7.00"
                  />
                </div>
                <div className="">
                  <div className="flex items-center justify-between border border-gray-300 p-2 px-4 rounded-md bg-white ">
                    <div className="flex gap-1.5 items-center">
          ...
          <div className="mt-2">
            <div className="bg-gray-100 rounded-lg">
              <p className="text-sm py-2 px-4 text-gray-500 ">
                Total Price : $7.00
              </p>
            </div>
          </div>
      ...
      <div className="flex flex-col md:flex-row gap-4 px-4 py-0">
        ...
        <div className="w-full md:w-1/3">
          ...
          <p className="text-sm text-gray-500">Add this course to a bundle.</p>
        </div>

        {/* Right side - Add to Bundles modal */}
        {isModalOpen && (
          <div className="w-full md:w-2/3 bg-white rounded-lg  border-gray-200">
            {/* Selected bundles section */}
            <div className="">
              {selectedBundles.map((bundle) => (
                <div
                  key={`selected-${bundle.id}`}
                  className="flex  justify-between mb-4 bg-accent p-2 rounded-md"
                >
                  <div className="flex  gap-3">
                    <div className="w-15 h-10 flex-none overflow-hidden">
                      <Image
                    ...
                    <div>
                      <p className="text-gray-700 text-xs line-clamp-1 font-semibold ">
                        {bundle.title}
                      </p>
                      <div className="flex items-center gap-2 mb-1">
                        <span className="bg-gray-200 text-gray-600  px-2 text-xs py-0.5 rounded-full">
                          Bundle
                        </span>
                        <div className="flex items-center bg-gray-200 text-gray-600 text-xs px-2 py-0.5 rounded-full">
                          <DollarSign size={12} />
            ...
            <div className="relative mb-4">
              ...
              <input
                type="text"
                className="block w-full pl-10 pr-3 py-2 text-sm border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-gray-200 text-gray-600"
            ...
            <div className="space-y-2">
              {filteredBundles.length > 0 ? (
                filteredBundles.map((bundle) => (
                  <div
                    key={bundle.id}
                    className="flex bg-accent p-2 rounded-md justify-between cursor-pointer"
                  ...
                  >
                    <div className="flex  gap-3">
                      ...
                      <div>
                        ...
                        <div className="bg-gray-200 text-gray-600 text-xs px-2 py-0.5 rounded-full inline-block mb-1">
                          Bundle
                        </div>
                      </div>
                    </div>
      ...
      <div className="flex flex-col md:flex-row ">
        ...
        <div className="w-full md:w-2/3 bg-white rounded-lg  border-gray-100">
          <div className="mt-4 px-4">
            <div className="space-y-3">
              {selectedSubscriptions.map((subscription) => (
                <div
                  key={`selected-${subscription.id}`}
                  className="flex  justify-between mb-4 bg-accent p-2 rounded-md"
                >
                  <div className="flex  gap-3">
                    <div className="w-15 h-10 flex-none overflow-hidden">
          ...
          <div className="mt-6 space-y-4 w-[92%] m-auto">
