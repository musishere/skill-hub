...
const StudentsAlsoBought = () => {
  ...
  const CourseCard: React.FC<{ course: Course }> = ({ course }) => (
    <div className=" bg-white flex rounded-xl gap-4 p-4 shadow-md border border-gray-200 transition-transform duration-300 hover:translate-y-[-4px] hover:shadow-lg">
    ...
    <Image
      ...
      <div className="flex flex-col h-[calc(100%-9rem)] justify-between">
        <div>
