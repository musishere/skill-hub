			...
			<div className='w-full'>
				<div className='p-4 lg:p-8'>
					...
					<div className='grid grid-cols-2 md:grid-cols-3 gap-4 mb-8 lg:mb-10'>
						{/* Lessons */}
						<div className='flex items-center gap-2 bg-accent rounded-md p-2'>
							<svg
						...
						{/* Duration */}
						<div className='flex items-center gap-2 bg-accent rounded-md p-2'>
							<VideoSvg className='size-5 fill-teal-600' />

							<div>
								<div className='text-sm font-semibold '>Duration</div>
								<span className='text-sm text-gray-600'>18h 22m</span>
							</div>
						</div>
						...
						<div className='flex items-center gap-2 bg-accent rounded-md p-2'>
							...
							<div>
								<div className='text-sm font-semibold'>Beg. & Int.</div>
						...
						{/* Certificate */}
						<div className='flex items-center gap-2 bg-accent rounded-md p-2'>
							<Certificate2 className='size-4 fill-teal-600' />
						...
						<HoverCard openDelay={50} closeDelay={50}>
							<HoverCardTrigger className='space-y-2'>
								<div className='flex items-center gap-2 bg-accent rounded-md p-2'>
									<CommunitySvg className='size-4 fill-teal-600' />
	...
	return (
		<div className='  flex flex-col items-center font-sans'>
			<div className='max-w-3xl  w-full mx-auto'>
				...
				<div className='bg-white p-4 rounded-2xl lg:p-10 flex flex-col md:flex-row gap-4 lg:gap-10 lg:shadow-md'>
					<div className='basis-[57%] flex flex-col relative'>
						...
						<div className='text-sm font-semibold leading-relaxed text-gray-900 mb-6'>
						...
						<div className='flex items-center justify-between mt-auto'>
							<div className='flex gap-2'>
								{testimonials.map((_, index) => (
									<button
										...
										className={`w-2 h-2 rounded-full border-2 border-teal-500 transition-all ${
											index === currentSlide
							...
							<div className='flex gap-3'>
								<button
									...
									className='w-8 h-8 border border-teal-500 rounded-full flex items-center justify-center transition-colors hover:bg-teal-500 group'
					...
					<div className='w-full h-36 relative '>
						...
						<div className='absolute bottom-4 left-2 bg-white px-3 py-2 rounded-lg flex items-center gap-2 cursor-pointer shadow-md transition-transform hover:-translate-y-0.5'>
							<span className='text-teal-500 font-semibold text-sm whitespace-nowrap'>
							...
							<svg
								...
								width='33'
							>
								<circle fill='#00bba7' r='16' cy='16.499' cx='16.8027'></circle>
								<path
									fill='white'
			...
			<div className='p-6'>
				...
				<div className='mt-4 space-y-2 text-gray-600'>
					...
					<div className='flex items-center gap-2'>
						<LinkSvg className='size-4' />
						<span className='text-sm font-semibold flex items-center gap-1'>
							<span className='text-amber-500'>✍️</span> 4D Copywriting Academy
							2.0
						</span>
					</div>
					<div className='flex items-center gap-2'>
