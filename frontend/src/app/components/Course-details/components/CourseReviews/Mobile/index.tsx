    ...
    <div className="flex ">
      <div className="w-full max-w-3xl flex justify-center">
        <div className="w-full max-w-3xl bg-white rounded-2xl p-4 lg:p-10 shadow-sm">
          ...
          <div className="flex flex-col gap-3 bg-sky-50 rounded-xl p-6 ">
            <div className="flex flex-col items-center gap-3">
              <div className="text-4xl font-bold text-gray-800  tracking-tight">4.3</div>
              <div className="text-lg font-semibold text-teal-500 ">★★★★☆</div>
              <div className="text-sm text-gray-600 font-semibold">43 Reviews</div>
              <div className="flex flex-col gap-3 items-center">
                <Link href="#" className="text-sm text-teal-500 font-semibold flex items-center gap-1 hover:underline">
                  Write a review →
                </Link>
                <Link href="#" className="text-sm text-teal-500 font-semibold flex items-center gap-1 hover:underline">
                  See all 73 reviews →
