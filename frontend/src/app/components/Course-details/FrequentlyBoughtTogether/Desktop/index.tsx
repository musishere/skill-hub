...
export default function FrequentlyBoughtTogether() {
  ...
  return (
    <div className='w-full bg-white rounded-lg shadow-sm p-4 lg:p-6'>
      <div className='flex  justify-between lg:items-center mb-6 border-b pb-4'>
        <div className='max-lg:mb-2 lg:flex gap-2 items-center'>
        ...
        <div className=''>
          <button
            className='bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md text-nowrap'
      ...
      <div className='space-y-6'>
        {courses.map((course) => (
          ...
          >
            ...
            <div className='w-[140px] h-[80px] relative overflow-hidden rounded flex-shrink-0'>
              <Image
